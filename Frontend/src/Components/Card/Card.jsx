...
>
  ...
  >
    ...
    <h2 class="md:text-3xl sm:text-3xl text-2xl font-bold mb-4 text-yellow-500">About QuizNova</h2>
    <p class="sm:text-lg md:text-lg text-base text-white leading-relaxed ">
        Welcome to QuizNova, your ultimate destination for intellectual growth and fun learning! 
    ...
    <p class="md:text-lg text-base text-white leading-relaxed mt-4 text-left md:w-1/2 sm:text-sm sm:w-72">
        At QuizNova, we believe that knowledge is the ultimate superpower, and we're here to equip 
