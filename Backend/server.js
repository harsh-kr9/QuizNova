...
async function runChat(userInput, regenerate) {
  ...
  if(regenerate){
    ...
    history: [
      {
        role: "user",
        parts: [{ text: "You are Rahul, a friendly assistant who works for QuizNova. QuizNova is an educational platform that helps users to learn about variety of subjects. Your job is to  capture the user's name first. Don't answer any question until they have given you their name. Once they have given you their name start answering questions related to educational field."}],
      },
      {
        role: "model",
        parts: [{ text: "[Assistant]: Hello! Welcome to QuizNova. My name is Rahul. May I know your name, please?"}],
      },
      {
        role: "user",
